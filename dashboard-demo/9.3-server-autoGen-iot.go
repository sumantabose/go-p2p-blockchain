...
func handlePost(w http.ResponseWriter, r *http.Request) {
    ...
    newProduct.Temperature = float64(genRandInt(101,200))/float64(10)
    newProduct.Humidity = genRandInt(21,70)
...
func handleInfoAll(w http.ResponseWriter, r *http.Request) {
    if len(ProductData) == 0 {
        _, _ = http.Get("http://supplychain-engine.herokuapp.com/next/30")
            ...
            for j, _ := range TempProductData {
                if TempProductData[j].SerialNo == SerialNo {
                    e := Event {
                        ...
                        Temperature: TempProductData[j].Temperature,
                        Humidity: TempProductData[j].Humidity,
                    }
...
func genRandPdt() (string, int) {
    ...
    PdtMap := map[string]int{
        "Grade A Natural Rubber": 300, "Grade B Natural Rubber": 200, "Grade A Synthetic Rubber": 250,
        "Grade B Synthetic Rubber": 150, "Grade A Natural Pulp": 320, "Grade B Natural Pulp": 280,
        "Grade A Cotton": 270, "Grade B Cotton": 220, "Grade A Tobaco": 170, "Grade B Tobaco": 120,
        "Grade A Jute": 280, "Grade B Jute": 230, "Grade A Sugarcane": 190, "Grade B Sugarcane": 140,
    }
    ...
    return "Grade A Tobaco", 170 // default - although it will never reach here
}
